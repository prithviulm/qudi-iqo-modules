...
4. **Clone the IQO Modules Repository**
   ...
   :::{note}
   Do not copy or move this folder after installation is complete!
   :::
...
default [dummy configuration](https://github.com/Ulm-IQO/qudi-iqo-modules/blob/main/src/qudi/default.cfg)
...
the [qudi-iqo-config repo](https://github.com/Ulm-IQO/qudi-iqo-config).
