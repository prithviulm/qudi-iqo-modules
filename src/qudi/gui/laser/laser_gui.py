...
class LaserGui(GuiBase):
    ...
    def _laser_clicked(self, checked):
        """
    Laser button callback. Disables button and sends a signal to the logic.
    Logic response will enable the button again.
    ...
    def _shutter_clicked(self, checked):
        """
    Shutter button callback. Disables the button and sends a signal to the logic. 
    The logic response will enable the button again.
    ...
    def _control_mode_clicked(self, mode):
        """
    Control mode button group callback. Disables control elements and sends a signal to the logic.
    The logic response will enable the control elements again.
