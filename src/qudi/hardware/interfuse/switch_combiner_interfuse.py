...
class SwitchCombinerInterfuse(SwitchInterface):
    ...
    def available_states(self):
        """
        Retrieve the names of the states as a dictionary of tuples.
        ...
        if self._extend_hardware_name:
            ...
            new_dict = {
                **self.switch1().available_states,
                **self.switch2().available_states,
            }
        return new_dict
    ...
    def number_of_switches(self):
        """
        Get the number of switches provided by the hardware.
    ...
    def switch_names(self):
        """
        Retrieve the names of all available switches as a tuple.

        Returns
        -------
        tuple
            Tuple of strings containing the available switch names.
        """
    ...
    def states(self):
        """
        Get the current states of the hardware as a state dictionary.

        The dictionary contains switch names as keys and state names as values.
    ...
    def states(self, state_dict):
        """
        Set the states of the hardware.

        The states of the system can be set by specifying a dictionary that has the switch names as keys
        and the names of the states as values.

        Parameters
        ----------
        state_dict : dict
            State dictionary in the form {"switch": "state"}.
        """
    ...
    def get_state(self, switch):
        """
        Query the state of a single switch by name.
